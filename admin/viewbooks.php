                    ...
                    if($count2>0){
                        ...
                        <div class="catalog">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="editBooks.php?id=<?php echo $id; ?>&name=<?php echo $name2; ?>"><button type="submit" style="background-color:#10ac84;">Edit&nbsp;<i class='fas fa-edit' style='font-size:24px'></i></button></a>
                        </li>
                            </ul>
                        </div><br>
                        <?php
