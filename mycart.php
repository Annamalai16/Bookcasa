...
<div class="container-fluid" style="margin-left:7%;">
    <h2 style="margin:auto !important;dispaly:block;padding-top:70px;font-family: 'Righteous', cursive;font-size:30px;margin-bottom:5%;">My Wishlist.</h2>
    <br>    
    <div class="container-fluid">
            <?php
                $sql2="SELECT * FROM mycart WHERE id='$id'";
                        ...
                        <div class="catalog">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo SITEURL; ?>delwishlist.php?id=<?php echo $id; ?>&name=<?php echo $name2; ?>&author=<?php echo $author2; ?>&image=<?php echo $image2; ?>&price=<?php echo $price2; ?>"><button type="submit" style="background-color:#d63031;">Delete Item &nbsp;&#9825;</button></a></li>
                            </ul>
                        </div><br>
                        <?php
                        }
